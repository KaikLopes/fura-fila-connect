...
// Importar shared-libs (referência a pasta pai)
const sharedLibsPath = path.join(__dirname, '../../shared-libs');
const { Logger, HealthCheck, healthCheckMiddleware, ResilientHttpClient } = require(sharedLibsPath);
